    ...
    return StreamBuilder<MediaItem?>(
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          ...
          if (extras == null || extras["downloadedSongJson"] == null) {
            onlineOrOffline = AppLocalizations.of(context)!.streaming;
          } else {
            onlineOrOffline = AppLocalizations.of(context)!.downloaded;
          }

          final shouldTranscode = extras != null && extras["shouldTranscode"] == true;
          if (shouldTranscode && (extras == null || extras["downloadedSongJson"] == null)) {
