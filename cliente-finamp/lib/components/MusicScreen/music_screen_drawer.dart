...
import '../../screens/synap_music/download_screen.dart';
            ...
            SliverList(
              delegate: SliverChildListDelegate.fixed(
                [
                  ...
                  ListTile(
                    leading: const Icon(Icons.explore, color: Color(0xFF1DB954)),
                    title: const Text('Descubrir SynapMusic', style: TextStyle(color: Color(0xFF1DB954), fontWeight: FontWeight.bold)),
                    onTap: () {
